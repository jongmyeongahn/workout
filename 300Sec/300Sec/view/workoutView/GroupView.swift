...
class GroupView: UIView {
    ...
    let subtitleLabel: UILabel = {
        ...
        let mainTitle = "Exercise Method\n"
        let subTitle = "1.Perform the exercises like a wave, one after another.\n 2.Take a rest within 10 seconds after each round.\n 3.Repeat for 300 seconds."
    ...
    private func setupVerticalStackView() {
        ...
        NSLayoutConstraint.activate([
            ...
            subtitleLabel.heightAnchor.constraint(equalTo: verticalStackView.heightAnchor, multiplier: 0.25),
