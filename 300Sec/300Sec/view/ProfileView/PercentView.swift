...
class PercentView: UIView {
    ...
    let inputTextField: UITextField = {
        ...
        textField.placeholder = "Enter 1RM weight"
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "Enter 1RM weight", attributes: placeholderAttributes)
    ...
    let percentTextField: UITextField = {
        let textField = UITextField()
        textField.textAlignment = .center
        textField.placeholder = "Enter 1RM Percent"
        textField.keyboardType = .numberPad
        textField.textColor = .white
        textField.backgroundColor = #colorLiteral(red: 0.01360723097, green: 0.01638710871, blue: 0.01815891452, alpha: 1)
        textField.borderStyle = .roundedRect
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "Enter 1RM Percent", attributes: placeholderAttributes)
        textField.font = UIFont.boldSystemFont(ofSize: 20)
        textField.translatesAutoresizingMaskIntoConstraints = false
        return textField
    }()
    ...
    let kgunitInputButton: UIButton = {
        ...
        kgunitInputButton.backgroundColor = .darkGray
    ...
    let lbunitInputButton: UIButton = {
        ...
        lbunitInputButton.backgroundColor = .green
    ...
    private func setUpView() {
        ...
        NSLayoutConstraint.activate([
            percentTextField.topAnchor.constraint(equalTo: inputTextField.bottomAnchor, constant: 20),
            percentTextField.centerXAnchor.constraint(equalTo: centerXAnchor),
            percentTextField.heightAnchor.constraint(equalToConstant: 40),
            percentTextField.widthAnchor.constraint(equalToConstant: 200)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            unitStackView.topAnchor.constraint(equalTo: percentTextField.bottomAnchor, constant: 20),
